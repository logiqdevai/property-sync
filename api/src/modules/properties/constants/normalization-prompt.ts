...
- city/district: prefer detail_specs "Περιοχή" when present, then raw_description (Υποπεριοχή/Γειτονιά), then raw_location. If all of those are missing or have no real place name, fall back to raw_title — many English listings bury the locality there (e.g. "Landplot – Milatos" → city "Μιλάτος", "Villa in Elounda with pool" → city "Ελούντα", "Apartment | Agios Nikolaos" → city "Άγιος Νικόλαος"). Extract only a real town/village/municipality from the title; ignore property-type words, sizes, amenities, and landmarks that are not settlements (e.g. "Spinalonga", "Cretan Sea"). Never use vague regions like "Crete" / "Κρήτη" / "Νότια Κρήτη" / "Βόρεια Ελλάδα" as city. When a place is written as "Locality (Municipality/Area)" (e.g. "Άγιος Κωνσταντίνος (Νικηφόρος Φωκάς)" or "Τριόπετρα (Λάμπη)"), set district to the full "Locality (Municipality)" string OR district=locality and city=parenthetical — never invent a vague region as city. Remember: convert to Greek spelling per the rule above even when the source text is in English
