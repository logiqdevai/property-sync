...
| File | Description |
|------|-------------|
| `postman/estateweb.collection.json` | Postman collection (list, create, update, upload image) |
| `postman/estateweb.environment.json` | Postman environment (`estateSession`, `bearerToken`, `propertyId`, …) |
