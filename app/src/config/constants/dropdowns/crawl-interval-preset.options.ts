export const CrawlIntervalPresetOptions: { id: string; label: string }[] = [
  ...
  { id: "0 0 * * *", label: "Once a day at midnight" },
  { id: "0 6 * * *", label: "Once a day at 06:00" },
  { id: "0 9 * * *", label: "Once a day at 09:00" },
  { id: "0 12 * * *", label: "Once a day at noon" },
  { id: "0 18 * * *", label: "Once a day at 18:00" },
  { id: "0 0 * * 1", label: "Weekly on Monday at midnight" },
  { id: "0 9 * * 1-5", label: "Weekdays at 09:00" },
];
